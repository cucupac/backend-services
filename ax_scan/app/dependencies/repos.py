...
async def get_mints_repo() -> IMintsRepo:
    return MintsRepo(db=await get_or_create_database())


async def get_points_repo() -> IPointsRepo:
    return PointsRepo(db=await get_or_create_database())
