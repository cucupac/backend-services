...
Revision ID: 0001
Revises: 
Create Date: 2023-01-31 16:23:09.181813
...
def upgrade():
    ...
    op.create_index(
        op.f("ix_relays_transaction_id"), "relays", ["transaction_id"], unique=False
    )
...
def downgrade():
    ...
    op.drop_index(
        "ix_emitter_address_source_chain_id_sequence", table_name="transactions"
    )
