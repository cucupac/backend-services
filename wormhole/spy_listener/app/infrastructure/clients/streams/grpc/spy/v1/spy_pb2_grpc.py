...
from app.infrastructure.clients.streams.grpc.spy.v1 import (
    spy_pb2 as spy_dot_v1_dot_spy__pb2,
)
...
class SpyRPCServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SubscribeSignedVAAByType = channel.unary_stream(
            "/spy.v1.SpyRPCService/SubscribeSignedVAAByType",
            request_serializer=spy_dot_v1_dot_spy__pb2.SubscribeSignedVAAByTypeRequest.SerializeToString,
            response_deserializer=spy_dot_v1_dot_spy__pb2.SubscribeSignedVAAByTypeResponse.FromString,
        )
...
class SpyRPCServiceServicer(object):
    ...
    def SubscribeSignedVAAByType(self, request, context):
...
def add_SpyRPCServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        "SubscribeSignedVAAByType": grpc.unary_stream_rpc_method_handler(
            servicer.SubscribeSignedVAAByType,
            request_deserializer=spy_dot_v1_dot_spy__pb2.SubscribeSignedVAAByTypeRequest.FromString,
            response_serializer=spy_dot_v1_dot_spy__pb2.SubscribeSignedVAAByTypeResponse.SerializeToString,
        ),
    }
...
class SpyRPCService(object):
    ...
    def SubscribeSignedVAAByType(
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            "/spy.v1.SpyRPCService/SubscribeSignedVAAByType",
            spy_dot_v1_dot_spy__pb2.SubscribeSignedVAAByTypeRequest.SerializeToString,
            spy_dot_v1_dot_spy__pb2.SubscribeSignedVAAByTypeResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
