...
class RetryQueuedTask(IRetryQueuedTask):
    def __init__(
        self,
    ...
    async def start_task(self) -> None:
        ...
        while True:
            ...
            await asyncio.sleep(settings.retry_queued_frequency)

    async def task(self):
        """Retries previously tracked, failed transactions."""
        self.logger.info("[RetryQueuedTask]: Task started.")

        transactions = await self.relays_repo.retrieve_non_relayed()
        ...
        self.logger.info("[RetryQueuedTask]: Sleeping now...")
